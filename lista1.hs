...
edad (d1,m1,a1) (d2,m2,a2) =  year_dif + div month_dif 12 + div day_dif 360
    where
        year_dif = abs (a2 - a1)
        month_dif = abs(m2 - m1)
        day_dif = abs(d2 - d1)
...
--EJERCICIO13
hms::Int->(Int, Int, Int)
--hms x = (div x 3600, div (x-(div x 3600)*3600) 60, x - (hours)*3600 - 60*div (minutes)*3600) 60 ) -- aixo es un puta merda.
